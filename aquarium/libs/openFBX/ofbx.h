...
struct Geometry : Object
{
	...
	virtual const std::vector<int> getFaceIndicesVector() const = 0;

	virtual const std::vector <Vec3> getVerticesVector() const = 0;
	virtual const std::vector <Vec3> getNormalsVector() const = 0;
	virtual const std::vector <Vec2> getUVsVector(int index = 0) const = 0;
	virtual const std::vector <Vec4> getColorsVector() const = 0;
	virtual const std::vector <Vec3> getTangentsVector() const = 0;
	virtual const std::vector<int> getMaterialsVector() const = 0;
