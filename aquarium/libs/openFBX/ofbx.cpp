...
struct GeometryImpl : Geometry
{
	...
	const std::vector<int> getFaceIndicesVector() const { return indices; }
	virtual const std::vector<Vec3> getVerticesVector() const { return vertices; }
	virtual const std::vector<Vec3> getNormalsVector() const { return normals; }
	virtual const std::vector<Vec2> getUVsVector(int index = 0) const { return uvs[index]; }
	virtual const std::vector<Vec4> getColorsVector() const { return colors; }
	virtual const std::vector<Vec3> getTangentsVector() const { return tangents; }
	virtual const std::vector<int> getMaterialsVector() const { return materials; }
};
